    ...
    this.renderChart({
      ...
      datasets: [
        
        {
          ...
          backgroundColor: '#5fb58a',
          data: [
            3,3,3,4,5,5,5,5,5,7,8,9,9,10,11
        ...
        },
        {
          ...
          backgroundColor: '#70c082',
          data: [
            72,72,72,72,76,76,76,89,89,89,89,89,114,114,114
        ...
        
        {
          ...
          backgroundColor: '#7ecb7a',
          data: [
            117,146,182,280,319,402,500,603,713,873,1054,1171,1233,1427,1506
        ...
        },
        {
          ...
          backgroundColor: '#8bd670',
          data: [
            192,221,257,356,400,483,581,697,807,969,1151,1269,1356,1551,1631
          ]
        },
        {
          ...
          backgroundColor: '#70c082',
          data: [
            77,31,36,69,44,84,98,116,110,162,182,118,87,195,80
        ...
        },
        {
          ...
          backgroundColor: '#70c082',
          data: [
            , , , 670,1078 ,1281 ,1421 ,1578 ,1562 ,1266 ,1857 , 1464,1587, 1906,1813
